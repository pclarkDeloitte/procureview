...
import questionObj from '../data/questionObjPeople.js'

import SurveyPageSubmit from '../modals/surveyPageSubmit.js'



class PeopleSurveySection extends Component {
    constructor(props) {
        super(props);
...
export default PeopleSurveySection;
