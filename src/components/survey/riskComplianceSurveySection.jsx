...
class riskComplianceSurveySection extends Component {
    constructor(props) {
        super(props);
        this.surveyPageSubmit = this.surveyPageSubmit.bind(this);
        this.state={
            currentSection: 'Risk and Compliance',
        ...
        return (
            <div style={{textAlign:'center', width:'100%',}}>
                ...
                <div style={{width:'90%',  marginLeft:'5%', marginBottom:20}}>
                    {this.renderSurveyPage('Risk and Compliance')}                    
                    <div                         
...
export default riskComplianceSurveySection;
